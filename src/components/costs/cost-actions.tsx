...
/**
 * Unified cost actions component for both order and vehicle costs
 * 
 * Provides edit and delete actions with confirmation dialog.
 * Designed to work with the unified cost API endpoints.
 * 
 * @component
 * @example
 * ```tsx
...
interface CostActionsProps {
  /** The cost to manage actions for */
  cost: Cost;
      ...
      <AlertDialog open={showDeleteDialog} onOpenChange={setShowDeleteDialog}>
        <AlertDialogContent>
          <AlertDialogHeader>
            ...
            <AlertDialogDescription>
              Bạn có chắc chắn muốn xóa chi phí này với số tiền{" "}
